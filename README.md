...
Use the immutable `@kungfu-tech/kfd@1.0.0-alpha.57` package cut and follow the
...
```bash
npx --yes --package @kungfu-tech/kfd@1.0.0-alpha.57 kfd scaffold agent-hub --language python --output my-agent-hub-adapter
npx --yes --package @kungfu-tech/kfd@1.0.0-alpha.57 kfd test agent-hub --adapter ./my-agent-hub-adapter/adapter.py --output agent-hub-report.json
npx --yes --package @kungfu-tech/kfd@1.0.0-alpha.57 kfd verify agent-hub-report agent-hub-report.json --adapter ./my-agent-hub-adapter/adapter.py --json
```
