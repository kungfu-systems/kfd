...
status: draft
period: 2026-07-17
theme: proof-carrying-work-object-propagation
doc_type: hypothesis
...
KFD produced the method trace and currently owns the case record. That makes
the record inspectable; it does not make the propagation claim true.
