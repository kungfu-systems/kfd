...
| Is KFD an internal kungfu-systems rulebook or an open engineering standard? | [`../README.md`](../README.md#about-this-repository) and [`../GOVERNANCE.md`](../GOVERNANCE.md) |
...
| Your question | Document |
|---|---|
| How should an agent quickly understand this package? | [`../README.md`](../README.md#choose-a-path), then [`../AGENTS.md`](../AGENTS.md), [`foundation.md`](foundation.md), and [`formal-model.md`](formal-model.md) |
...
| What is the concrete self-proof path for KFD-1 through KFD-13? | [`repository-guide.md`](repository-guide.md#product-proof-path), the KFD formal and usage pages, and the package witnesses under [`../.buildchain/`](../.buildchain/) |
...
| Where is the public KFD fact source? | [`repository-guide.md`](repository-guide.md#decision-metadata) and [`../site/kfd-site.json`](../site/kfd-site.json) decision metadata |
