...
| How did an Agent generate Admission and compress Claim, Assessment, Decision, and Admission into KFD-11? | [`../cases/live/decision-admission-settlement/README.md`](../cases/live/decision-admission-settlement/README.md), then its [`genesis.md`](../cases/live/decision-admission-settlement/genesis.md) and [`kfd-method-trace.md`](../cases/live/decision-admission-settlement/kfd-method-trace.md) |
