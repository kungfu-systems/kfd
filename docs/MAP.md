...
| How is the Work candidate distinguished from Initiative, a derived Work view, and no new Primitive? | [`../cases/live/federated-work-continuity/distinguishability.md`](../cases/live/federated-work-continuity/distinguishability.md) and its [`current KFD-5 cut`](../cases/live/federated-work-continuity/cuts/0001-work.json) |
