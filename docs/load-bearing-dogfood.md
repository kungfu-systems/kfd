...
| Build, merge, and release feedback | Bind protected delivery evidence back into runtime and portable settlement | active frontier | [Buildchain](https://buildchain.libkungfu.dev), [KFD product proof path](../README.md#product-proof-path) |
