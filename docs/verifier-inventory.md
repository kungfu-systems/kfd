...
| GAP-KFD-7-1 | KFD-7 | Runtime Profile evidence is not yet retained across the product and release-gate owners | Structural validity cannot qualify role necessity, transition behavior, or activation | Package the draft action-contract schema and fail-closed fixtures now; keep activation pending until product witnesses and independent review bind an exact evidence cut |
