...
const buildSelfConformancePage = ({
  ...
  return {
    ...
    readerModel: {
      question: "How should a reader connect KFD's live governance gate with its reconstructed history without granting either lane authority it does not have?",
      prospective: {
        label: "Prospective governance",
        applicability: "Official Candidate genesis, qualification, numbering, status, Foundation Revision, and release-packaging transitions under the live Profile.",
        gate: "The applicable live Self-Conformance gate must pass before an official lifecycle transition proceeds.",
        ordinaryEditsBoundary: "Ordinary repository edits do not silently become lifecycle transitions.",
      },
      retrospective: {
        label: "Retrospective structural conformance",
        start: {
        ...
        convergence: {
          liveAnchorId: history.convergence.liveAnchorId,
          compatibility: history.convergence.compatibility,
          historicalDoesNotReplaceLive: history.convergence.historicalDoesNotReplaceLive,
        },
        retrospective: history.retrospective,
        profileAvailableAtEvent: history.profileAvailableAtEvent,
        claim: "This later structural replay does not project the Profile into historical events or retroactively approve, authorize, activate, certify, or change them.",
      },
      authorityBoundary: {
        ...
        forbiddenInferences: [
          "semantic truth",
          "retroactive approval or authority",
          "number allocation or status change",
          "activation or certification",
          "adoption or production fitness",
          "publication or release authority",
        ],
      },
      links: [
        { label: "Live Self-Conformance Profile", url: "/profiles/self-conformance/README.md" },
        { label: "Historical lineage guide", url: "/profiles/self-conformance/history/README.md" },
        { label: "Historical lineage report", url: "/profiles/self-conformance/history/historical-lineage.report.json" },
        { label: "Live Profile manifest", url: "/profiles/self-conformance/manifest.json" },
      ],
    },
    governedObjects: [
  ...
  return {
    ...
    homepage: {
      ...
      selfConformance: {
        ...
        readerModel: selfConformancePage.readerModel,
      },
      currentDecisions: {
